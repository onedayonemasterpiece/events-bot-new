    ...
    *,
    ...
    specs = [
        ...
        ToolSpec("social_action_prepare", "Prepare social action",
                 "Persist the exact action requested by the current user. Outbound actions become immediately committable; edit/delete require external approval. This never executes the action.",
        ...
        ToolSpec("social_action_commit", "Commit approved social action",
                 "Atomically consume the preparation authorization before the sole provider attempt; call immediately after an explicitly requested outbound prepare.",
