...
def load_config() -> AcqConfig:
    ...
    return AcqConfig(
        ...
        max_surfaces_per_run=_int("ACQ_MAX_SURFACES_PER_RUN", 4, min_value=1),
        max_messages_per_surface=_int("ACQ_MAX_MESSAGES_PER_SURFACE", 40, min_value=1),
        max_threads_per_surface=_int("ACQ_MAX_THREADS_PER_SURFACE", 8, min_value=1),
        max_opportunities_per_run=_int("ACQ_MAX_OPPORTUNITIES_PER_RUN", 20, min_value=1),
