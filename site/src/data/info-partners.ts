...
export const INFO_PARTNERS: InfoPartner[] = [
  ...
  {
    id: 'icae-kaliningrad',
    name: 'Информационный центр по атомной энергии в Калининграде',
    shortName: 'ИЦАЭ Калининграда',
    description: 'Информационный центр по атомной энергии в Калининграде.',
    compactLabel: '',
    href: 'https://klgd.myatom.ru/',
    accent: '#e6571d',
    logoText: 'ИЦАЭ Калининграда',
    logoUrl: '/assets/partners/icae-kaliningrad.svg',
    logoAlt: 'Логотип ИЦАЭ Калининграда',
    logoShape: 'wide',
    logoSurface: 'transparent',
    priority: 'primary',
    gridColumnStart: 1,
