...
test('September free collection consumes the exact diverse Golden Event Corpus v2 projection', () => {
  const scenario = registry.scenarios['free-collection-september-desktop-v3'];
  ...
  assert.equal(scenario.reference_timestamp, '2026-08-29T14:00:00+02:00');
  assert.equal(scenario.reference_date, '2026-08-29');
  assert.equal(registry.scenarios['free-collection-september-mobile-v3'].reference_timestamp, scenario.reference_timestamp);
