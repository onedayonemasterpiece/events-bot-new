...
try {
  ...
  await page.waitForFunction(() => document.querySelector('[data-free-collection-medallion]')?.dataset.fiFreeCompact === 'true');
  assert.equal(await page.locator('[data-free-collection-medallion="large"]').isVisible(), true);
