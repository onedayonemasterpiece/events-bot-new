...
const PUBLIC_SEARCH_KEYS = Object.freeze({
  PUBLIC_EVENT_SEARCH_ASSISTANT_ENABLED: ['PUBLIC_EVENT_SEARCH_ASSISTANT_ENABLED'],
  PUBLIC_EVENT_SEARCH_ASSISTANT_HOST: ['PUBLIC_EVENT_SEARCH_ASSISTANT_HOST'],
  PUBLIC_EVENT_SEARCH_ASSISTANT_CAPTURE_ONLY: ['PUBLIC_EVENT_SEARCH_ASSISTANT_CAPTURE_ONLY'],
