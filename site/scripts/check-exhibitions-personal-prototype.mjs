...
const checks = [
  ...
  ['deck uses real conditional right-overlap frames', !rowSource.includes('ex-deck__edge-stack') && rowSource.includes('data-deck-frame') && pageSource.includes("frame.dataset.deckState = 'stack'") && pageSource.includes('stackLeft + index * sliver') && pageSource.includes('String(50 - index)')],
