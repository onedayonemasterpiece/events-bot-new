...
const COMMAND = /^\/qa run scenario=(focus\.otp\.(?:browser_tab|ios_keyboard_preflight)) platform=(browser|android|ios|all) target_url=(\S+) expected_repo_sha=([0-9a-f]{40}) mode=(blocking)$/u;
