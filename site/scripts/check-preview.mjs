...
const required = [
  ...
  'lab/event-desktop/examples/split-multi-portrait/index.html',
  'lab/event-desktop/examples/split-ocr-with-photos/index.html',
...
for (const marker of [
  ...
  'action-metric-row',
  'action-onboarding-lab',
  'onboarding-pattern-coachmark',
...
const desktopExampleContracts = [
  ...
  ['editorial-photo-continuous', 5658, 'editorial', 'non-ocr', ['Спектакль «Гараж»', 'data-editorial-motion="continuous"', 'data-editorial-crop="exact"', '--image-position:50% 80%', 'data-responsive-rail']],
  ...
  ['editorial-ocr-companion', 6323, 'editorial', 'ocr', ['Празднование Ивана Купалы', 'data-selected-media-policy="visual_only"', 'data-ocr-companion-layout="separate"', 'data-editorial-ocr-companion', 'data-source-index="0"']],
  ['editorial-ocr-companion-integrated', 6323, 'editorial', 'ocr', ['Празднование Ивана Купалы', 'data-ocr-companion-layout="integrated"', 'data-editorial-companion-board', 'data-editorial-ocr-companion']],
...
if (!bundledJs.includes('functions/v1/event-issue-report') || !bundledJs.includes('admin') || !bundledJs.includes('report_text') || !bundledJs.includes('artkodex_thread_url')) throw new Error('Bundled JS must include authenticated admin event issue report submission and thread-history wiring');
