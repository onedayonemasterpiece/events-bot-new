...
if (!controlVisibleHtml.includes('hero-gallery__brand') || !controlVisibleHtml.includes('Полюбить Калининград') || !controlVisibleHtml.includes('hero-gallery__slide') || !controlVisibleHtml.includes('Фото события')) throw new Error('Hero gallery must keep the service tag and a readable bottom title stripe');
