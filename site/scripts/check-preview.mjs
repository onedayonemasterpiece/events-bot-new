...
const desktopExampleContracts = [
  ...
  ['editorial-photo-continuous', 5658, 'editorial', 'non-ocr', ['Спектакль «Гараж»', 'data-editorial-motion="continuous"', 'data-editorial-crop="exact"', '--image-position:50% 80%', 'data-responsive-rail', 'loading="eager"']],
