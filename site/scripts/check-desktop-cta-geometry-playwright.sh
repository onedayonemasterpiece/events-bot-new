...
# stacked tactile Split ticket-card contract.
check_geometry "split CTA fixture" "lab/event-desktop/examples/cta-phone-invariant" split
check_geometry "registration CTA fixture" "lab/event-desktop/examples/cta-registration-invariant" split "Зарегистрироваться" 3
