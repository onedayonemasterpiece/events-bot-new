...
export function productionHealthEvidenceRecord(input = {}) {
  ...
  const record = {
    ...
    preflight: {
      ...
      failure_stage: closedText(preflight.failure_stage, /^[a-z][a-z0-9_]{2,63}$/u),
      failure_class: closedText(preflight.failure_class, /^[a-z][a-z0-9_]{2,63}$/u),
      error_class: closedText(preflight.error_class, /^[a-z][a-z0-9_]{2,63}$/u),
      ...
      ...(preflight.safari_ui && typeof preflight.safari_ui === 'object' ? {
        safari_ui: {
          ...
          continue_button_count: safeCount(preflight.safari_ui.continue_button_count),
          active_app_owner: closedText(preflight.safari_ui.active_app_owner,
            /^(?:springboard|safari|other|unknown)$/u) || 'unknown',
          source_inspected: preflight.safari_ui.source_inspected === true,
          application_container_count: safeCount(preflight.safari_ui.application_container_count),
          alert_container_count: safeCount(preflight.safari_ui.alert_container_count),
          sheet_container_count: safeCount(preflight.safari_ui.sheet_container_count),
          title_match_count: safeCount(preflight.safari_ui.title_match_count),
          continue_match_count: safeCount(preflight.safari_ui.continue_match_count),
          settings_match_count: safeCount(preflight.safari_ui.settings_match_count),
          matched_static_text_count: safeCount(preflight.safari_ui.matched_static_text_count),
          matched_button_count: safeCount(preflight.safari_ui.matched_button_count),
          matched_other_type_count: safeCount(preflight.safari_ui.matched_other_type_count),
        },
      } : {}),
    },
