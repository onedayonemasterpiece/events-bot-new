export function focusOtpFailureDomain(error) {
  ...
  if (/missing_configuration|configuration_invalid|configuration_missing|simulator_(?:runtime|appium|configuration|safari_navigation)|target_url|websocket_connect/iu.test(message)) return 'BLOCKED_INFRASTRUCTURE';
