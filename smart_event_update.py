...
async def _llm_merge_event(
    ...
    *,
    ...
    prompt = (
        ...
        "Для cancellation/postponement notice по умолчанию сохраняй event_before.title: не укорачивай "
        "и не выкидывай собственное название/название программы из уже существующего заголовка "
        "(например `Александр Буйнов: Лучшие песни` не превращай в `Александр Буйнов`), "
        "если новый источник явно не даёт более точное attendee-facing название. "
