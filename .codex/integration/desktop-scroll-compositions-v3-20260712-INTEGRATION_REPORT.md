...
| integrator | R01–R06 | `feature/event-page-desktop-scroll-compositions-v3-20260712` | committed, pushed and deployed | Implementation `144884a4` + interaction fix `4db7a3fa`; environment-backed Astro build/check and local/public `49`-run Chromium QA with zero failures |
