...
- Removed substring/default conversion of verifier diagnostics into product no-event; only an explicit source-grounded high-confidence LLM `non_event` verdict is a product terminal, while malformed/uncertain output fails technical.
