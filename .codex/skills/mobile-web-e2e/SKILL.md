...
- A successful native gesture is not the terminal Search scroll assertion. Keep
  swiping until the final rendered card actually intersects the WebKit/Chrome
