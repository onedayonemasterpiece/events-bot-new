...
- `Полюбить Калининград` (`lovekenigofficial`) replacements: `👉` document id `5204036388789445008`; `🎭` document id `5390961951150988955`; Tretyakov pair `🖼🖼` document ids `5188683852096234620,5188445640325099838` from `https://t.me/addemoji/lovekenigofficial`.
