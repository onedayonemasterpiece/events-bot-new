...
## Head SHA
`89a89a158166f84d04ba1158b8b84fe65b69e7a2` (latest implementation commit; the committed lane record is a results-only follow-up)

## Files changed
- `tools/autopresenter/relay/control/index.html`
- `tools/autopresenter/relay/control/auth-storage.js`
...
- `tools/autopresenter/relay/tests/control_auth.test.mjs`
...
- `node --test tools/autopresenter/relay/tests/control_auth.test.mjs`
- `node --check tools/autopresenter/relay/control/auth-storage.js`
...
- PWA auth-storage behavioral suite: **2 passed**; it simulates an onboarding page session, a fresh installed-app session sharing only persistent origin storage, restoration into the new session, and scoped access reset without deleting unrelated keys.
...
## Merge notes
- Cherry-pick implementation commits `e89ecabb0b41454017e705f5d76fb6486be3fa42`, `61fb381ffa9d32afd8bbc8348db5cf92288950e2`, and `89a89a158166f84d04ba1158b8b84fe65b69e7a2`, then the results-only commits if lane evidence is desired in the integration branch.
