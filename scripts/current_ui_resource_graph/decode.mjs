...
async function run(argv) {
  ...
  try {
    ...
    const manifest = {
      ...
      visual_evidence_contract: { raw_raster_role: 'noncanonical_visual_evidence', diagnostic_fingerprint: 'dhash-64', in_session_stability: 'bounded_until_two_consecutive_playwright_pixelmatch_frames_threshold_0_2_max_diff_pixels_0', cross_run_acceptance: 'human_review_with_hash_bound_rasters' },
