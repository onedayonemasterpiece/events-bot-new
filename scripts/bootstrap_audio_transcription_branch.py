...
def main() -> None:
    ...
    # Verify the central guard without importing the full production bot. The
    # production module imports the Kaggle client and database models, which is
    # intentionally outside this focused skeleton gate.
    guard_test = REPO / "tests" / "test_audio_transcription_remote_session_guard.py"
