...
BUILD_ID_DEFAULT = "preview-20260722-mobile-menu-reference4-leather-tag-lab-v10"
...
REFERENCE4_CSS = r'''
/* v10: the leather summary rides with the plane; it is never pinned over open navigation. */
.variant-reference4-leather-tag .mobile-discovery-menu{--plane-h:100dvh;height:calc(100dvh + var(--shell-tag-h));transform:translate3d(0,calc(-100dvh - env(safe-area-inset-top)),0)}
.variant-reference4-leather-tag .mobile-discovery-menu[open]{transform:translate3d(0,0,0)}
.variant-reference4-leather-tag .mobile-discovery-menu.is-closing{transform:translate3d(0,calc(-100dvh - env(safe-area-inset-top)),0)}
...
.variant-reference4-leather-tag .mobile-discovery-menu__panel{height:100dvh;padding:env(safe-area-inset-top) 0 0;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch;border:0;border-radius:0;background:radial-gradient(62% 30% at 18% 7%,rgba(160,78,45,.18),transparent 70%),linear-gradient(180deg,rgba(70,36,25,.15) 0,rgba(227,216,207,.14) 32%,rgba(241,235,228,.18) 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.56),0 20px 46px rgba(46,25,16,.24);backdrop-filter:blur(22px) saturate(.96) brightness(.84);-webkit-backdrop-filter:blur(22px) saturate(.96) brightness(.84)}
.variant-reference4-leather-tag .mobile-discovery-menu__summary{z-index:3!important;background:transparent url("./assets/ui/mobile-head-skinny-leather-3x.webp") center/100% 100% no-repeat!important;box-shadow:none!important;filter:drop-shadow(0 8px 8px rgba(52,25,16,.22)) drop-shadow(0 15px 20px rgba(52,25,16,.14));transition:box-shadow 220ms ease!important}
.variant-reference4-leather-tag .mobile-discovery-menu__summary .brand-tag__endorsement{color:#fffaf4;text-shadow:0 1px 1.5px rgba(60,20,10,.38),0 0 1px rgba(60,20,10,.22)}
.variant-reference4-leather-tag .mobile-discovery-menu__summary .brand-tag__wordmark{filter:brightness(0) invert(1) drop-shadow(0 1px 1px rgba(60,20,10,.34))}
.variant-reference4-leather-tag .mobile-discovery-menu__summary .brand-tag__chevron{opacity:.72;filter:drop-shadow(0 1px 1px rgba(60,20,10,.34))}
...
.reference4-menu__brand{box-sizing:border-box;width:174px;height:104px;display:grid;grid-template-rows:11px auto;align-content:end;gap:4px;padding:34px 0 12px;color:#2b211c;text-decoration:none;filter:drop-shadow(0 1px 1px rgba(255,255,255,.28))}
.reference4-menu__endorsement{align-self:end;font-size:9px;line-height:10px;font-weight:780;letter-spacing:.05em;text-transform:uppercase;white-space:nowrap;opacity:.92}
