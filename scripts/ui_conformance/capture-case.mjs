...
try {
  ...
  const outputFacts = { ...facts, bounded_browser_evidence: bounded, capture: screenshot, locale:'ru-RU', timezone:'Europe/Kaliningrad', device_scale_factor:data.container_geometry.device_scale_factor, animations_disabled:true, caret_hidden:true, reduced_motion:true, fixture_network_bound:false, frozen_clock:data.reference_clock };
