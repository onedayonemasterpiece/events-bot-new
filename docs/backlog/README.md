...
- Post-release видео для сайта «Полюбить Калининград Анонсы»: пользовательские гайды «Как быстро найти событие» и отдельный план source-grounded видео в event page: `docs/backlog/features/static-site-video-guides/README.md`
