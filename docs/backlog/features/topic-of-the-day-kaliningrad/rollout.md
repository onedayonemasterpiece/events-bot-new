...
Нужны ответы владельца продукта, но они не блокируют docs-first архитектуру. Уже решены: `0..1`, ручной approve каждого выпуска, любые публичные source photos со ссылкой и полноценный голос официальных источников.

1. Где удобнее просматривать и одобрять выпуск: в закрытом Telegram admin-чате с кнопками, в XLSX/HTML report или в отдельной web-панели?
