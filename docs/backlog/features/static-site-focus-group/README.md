...
- onboarding стал последовательным: на экране виден только текущий выбор;
  ...
  остаётся маленьким явным действием;
...
- при неуспешной или уже использованной ссылке экран сразу раскрывает адрес и
  поле шестизначного кода; пользователь может ввести код из уже полученного
  письма без запроса нового;
- канонические файлы:
