...
Один приз — два билета в театр. Точный театр, доступные даты и спектакли,
ограничения и получение определяются только опубликованными правилами.
Основной результат — доля собранной коллекции; дополнительный — ограниченная
широта исследовательских действий. Значение NPS, позитивность, длина текста,
повторные действия, приглашения друзей и публикации не дают преимущества.
```
...
- [ ] Награда сформулирована ровно как `два билета в театр`; конкретные
      спектакли не додуманы без опубликованных правил.
- [ ] NPS value, sentiment, длина текста, повторы, share и invite не дают
      преимущества; negative feedback учитывается симметрично.
