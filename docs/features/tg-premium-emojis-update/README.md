...
- Free-label document ids: `5406749623865857008`, `5407072545276973461`, `5406815783542085177`, `5406927577245833438`. Single emoji ids: `👉` → `5204036388789445008`, `🎭` → `5390961951150988955` from `Полюбить Калининград`; `💰` → `5305700407874449437`, `📗` → `5339143926638996892`, `🏰` → `5305794630866989617` from `https://t.me/addemoji/MostVKenig`.
...
- регулярные `👉`/`🎭` and inserted `💰`/`📗`/`🏰` получили `MessageEntityCustomEmoji` из соответствующих наборов;
