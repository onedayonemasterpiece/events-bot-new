...
- Free-label document ids: `5406749623865857008`, `5407072545276973461`, `5406815783542085177`, `5406927577245833438`. Single emoji ids from the same `Полюбить Калининград` custom emoji set: `👉` → `5204036388789445008`, `🎭` → `5390961951150988955`.
...
- `TG_PREMIUM_EMOJI_DAILY_SINGLE_DOCUMENT_IDS_JSON` — опциональный JSON override для одиночных daily emoji, например `{"👉":5204036388789445008,"🎭":5390961951150988955}`.
...
- регулярные `👉` и `🎭` получили `MessageEntityCustomEmoji` из набора `Полюбить Калининград`;
