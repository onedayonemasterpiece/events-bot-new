...
- `docs/features/static-site-pages/auto-present/README.md` — docs-first автопрезентатор реального static-site UI: управляемый с телефона Playwright MVP, Windows portable runner и общий live/record сценарий
