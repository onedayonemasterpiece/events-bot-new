...
- `docs/features/event-comment-feedback/README.md` — **Сигналы обсуждения**: offline/Kaggle probe для агрегированных смысловых сигналов из комментариев к источникам события
