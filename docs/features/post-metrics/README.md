...
- репост: `+8` баллов — самый сильный сигнал, потому что создаёт новый узел
  распространения;
- комментарий: `+5` баллов — сильная осмысленная вовлечённость;
- лайк: `+1` балл — лёгкая реакция;
- просмотр: `+0.02` балла, но не больше `20` баллов на пост — слабый сигнал и
  не должен перебивать явную активность.
