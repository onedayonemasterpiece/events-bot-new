...
**Data-prep v2 production 2026-08-01:** implementation PR #182 слит в main и
развёрнут на Fly v1853 из
`c5e3f6bc79e912992379280644515137917a414d`. Реализованы durable
...
grounded relations. Production catch-up поставил `80` exact candidates в тот же
outbox; первая волна увеличила relations `19 -> 34`, а provider-limited хвост
остаётся retryable. На live DB все шесть approved identities имеют активность в
inclusive окне 2026-02-01..2026-08-01 (`15, 3, 7, 2, 2, 1` relations), две
shadow identities не публикуются. Это не изменение существующих Astro routes;
terminal StaticSiteBuilder cold/warm acceptance ещё открыт.
