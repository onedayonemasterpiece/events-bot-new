...
- [ ] **Partial** — add a real ДС «Янтарный» regression before enabling the venue-specific `Елизаветинская` option: one train row must offer separately clickable Южный/Северный boarding times, show the official `35 ₽` fare once, retain the 650 m / 8–10 min walk and exclude unrelated Калининград events.
