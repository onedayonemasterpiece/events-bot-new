...
| iOS Safari identity | `PARTIAL` | Browser-tab OTP, direct-outage и relay-outage terminal acceptance получены; нужен final-target anonymous→verified upgrade journey |
