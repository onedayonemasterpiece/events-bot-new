...
В footer CTA отделён от списка навигации и социальных ссылок коротким
продуктовым лидом **«Понравилась афиша?»** и пояснением
**«Поделитесь KenigEvents — афишей событий Калининграда и области.»**. Это не
второй H1 страницы, а локальный контекст action; сама кнопка остаётся короткой:
