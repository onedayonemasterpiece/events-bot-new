...
показы выставок и фестивалей, девять кадров базы шуток и QR-outro остаются
явными scene IDs. Универсального DSL и редактора нет.
...
отдельные крупнотипографические кадры. Для шуток 03 и 07 автор потребовал TTS.
