...
PUBLIC_UI_SOT_SCENARIO=free-collection-september-desktop-v3 \
npm --prefix site run build
```

Route: `/podborki/besplatnye-sobytiya/`.

The scenario freezes `2026-08-29T14:00:00+02:00` in `Europe/Kaliningrad` with `ru-RU`; the mobile sibling is `free-collection-september-mobile-v3`. Input fixture order is `2182, 6711, 7609, 8006, 8200`. The production surface
