...
Проверка V7 выявила раннюю остановку на `0`; `accepted-v8` повторяет непрерывный
photo motion на всём видимом OCR stage через симметричный bounded crop
(`10% + 10%`) без zoom и без открытия пустых краёв.
