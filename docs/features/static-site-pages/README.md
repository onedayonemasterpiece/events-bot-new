...
> **Full release scope:** [240-item Stage 0–12 readiness checklist](../../reports/static-personal-announcements-release-readiness-2026-07-11.md) (228-item recovered baseline plus later reconciled requirements).
> **Presentation gate / test inventory:** [presentation checklist](presentation-release-checklist.md) · [215 scenarios](test-scenarios.md).
