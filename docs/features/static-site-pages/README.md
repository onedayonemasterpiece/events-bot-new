...
The separate `/lab/event-desktop/` choice surface now covers three horizontal/square and three portrait-OCR desktop compositions without selecting one prematurely. It enforces one owner per fact/action, preserves the mobile overlap baseline, keeps portrait posters contained, and records the corrected CTA/onboarding/icon contracts. Canonical document: `event-desktop-layout-lab-2026-07-11.md`.
