...
- Desktop event-page lab: `preview-20260711t-desktop-event-layouts/lab/event-desktop/` compares H1/H2/H3 for horizontal or square hero media and P1/P2/P3 for portrait OCR posters. It is a noindex choice surface rather than a default desktop rollout: every option has one owner per fact/action, keeps calendar/share/like visible, shows the transition to the standard `Смотрите дальше`, and leaves the accepted mobile hero-overlap contract untouched. This preview uses a fresh 2026-07-11 Fly snapshot (`312` active/future events through id `6832`) and also exposes corrected real-event stress pages `6345`, `6510`, `6678`, `6750`. Canonical notes: `event-desktop-layout-lab-2026-07-11.md`.
