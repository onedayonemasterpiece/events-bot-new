...
> **Build ID:** `preview-20260627-event-pages-v22`
> **Public preview index:** <https://kenigevents.ru/preview-20260627-event-pages-v22/__preview/>
...
- Control event page: <https://kenigevents.ru/preview-20260627-event-pages-v22/sobytiya/pesni-sssr-svetlogorsk-5878/>
- Control event calendar file: <https://kenigevents.ru/preview-20260627-event-pages-v22/sobytiya/pesni-sssr-svetlogorsk-5878/event.ics>
- Control discovery JSON: <https://kenigevents.ru/preview-20260627-event-pages-v22/data/discovery/5878.json>
- Preview sitemap: <https://kenigevents.ru/preview-20260627-event-pages-v22/sitemap.xml>
- Preview robots: <https://kenigevents.ru/preview-20260627-event-pages-v22/robots.txt>
...
- Yandex Object Storage website fallback: <http://kenigevents.ru.website.yandexcloud.net/preview-20260627-event-pages-v22/__preview/>
...
- Preview canonical and `og:url` include `/preview-20260627-event-pages-v22/`; production canonical is not emitted by the preview build.
...
cd site
npm install
PREVIEW_BUILD_ID=preview-20260627-event-pages-v22 npm run build:preview
PREVIEW_BUILD_ID=preview-20260627-event-pages-v22 npm run check:preview
PREVIEW_BUILD_ID=preview-20260627-event-pages-v22 npm run deploy:preview
```
...
The first public preview (`preview-20260627-event-pages-v1`) was superseded after visual review. The current `preview-20260627-event-pages-v22` keeps the event page mobile/feed-oriented and feedback-aware, and replaces the v19 safe image block with the v20 hero composition lab from `event-hero-lab-2026-06-27.md`:
...
After direct product review, `preview-20260627-event-pages-v22` rolls back the UX regressions introduced by the split recommendation rails and adds the first static-seed/client-hydration discovery contract:
...
After consultant review, `preview-20260627-event-pages-v22` additionally hardens the first discovery layer:
...
`preview-20260627-event-pages-v22` keeps the discovery implementation aligned with the documented `event_detail_related` contract:
...
`npm run check:preview` passed for `preview-20260627-event-pages-v22`: the control discovery JSON is checked for `schema_version=event-detail-related-v1`, `surface=event_detail_related`, `algorithm_id=static_related_v1`, `related_static[]`, display calendar fields, source/social counter consistency, footer social links/icons, parseable Event-class JSON-LD and both feed-card UI variants, the hero lab/review routes, poster/photo hero modes, explicit composition markers, one-H1 contract and split-actions icon styling. Playwright smoke evidence for the v20 hero is stored locally under `artifacts/codex/hero-impact-v20/` (not committed): 375/390/430 mobile control screenshots, photo/parallax screenshots, viewport metrics and `hero-smoke-result.json`.
