...
- Event decision-block A/B lab: `<preview>/lab/event-decision-block/` preserves superseded A–F markers for rollback history, but the active 2026-07-05 surface compares constrained hero-overlap V2 variants: H1 inside the decision sheet, strong date, mandatory buy/calendar/share/like icon actions, large medallion shelves and zero-medallion safety. Current review target: `preview-20260705t-decision-block-v2`.
