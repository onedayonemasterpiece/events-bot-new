...
- Desktop event-page media lab: `preview-20260712t-desktop-continuous-scroll-v4/lab/event-desktop/` keeps the earlier matrix but corrects four scroll compositions: one uninterrupted Editorial slab with sticky rail/CTA, a verified horizontal photo promoted for OCR-primary event `4671`, a slow physical Split poster, a physical vertical photo strip, and a portrait + adaptive Bento candidate. Every slow-media stage releases before `Смотрите дальше`; reduced motion returns it to normal flow. The surface remains hidden below `1024px`; production mobile components/styles are untouched. Preserved v3: `preview-20260712t-desktop-scroll-compositions-v3/lab/event-desktop/`; preserved v2: `preview-20260712t-desktop-clean-pages-v2/lab/event-desktop/`. Canonical notes: `event-desktop-media-families-2026-07-12.md`.
