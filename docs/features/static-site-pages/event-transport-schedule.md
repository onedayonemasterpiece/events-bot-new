...
- responsive bundled maps use a square crop on desktop/tablet and a portrait crop on mobile because the preferred route is mostly north–south. Both visibly draw the same route; the map area has one walking CTA plus the venue-coordinate link.
