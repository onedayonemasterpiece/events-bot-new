...
> **Release-plan provenance:** документ импортирован без смысловых изменений из [`feature/static-typed-intro-prototype-20260715@8045599b`](https://github.com/onedayonemasterpiece/events-bot-new/tree/feature/static-typed-intro-prototype-20260715); raw consultation evidence остаётся незакоммиченным в `artifacts/codex/static-typed-intro-consultation-20260715/` и не является production evidence.
