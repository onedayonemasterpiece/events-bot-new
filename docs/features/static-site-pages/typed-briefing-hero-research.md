...
consultation evidence in side branch
`origin/integration/typed-briefing-dynamic-shield-face-kinetics-20260717@b5f4797d`
under `docs/reports/static-typed-briefing-consultation-2026-07-15/`.
...
- evidence README, prompts and Gemini review trace remain in the exact side branch
  `origin/integration/typed-briefing-dynamic-shield-face-kinetics-20260717@b5f4797d`
  under `docs/reports/static-typed-briefing-consultation-2026-07-15/`; they are
  referenced as branch evidence and are not duplicated into the canonical release
  documentation until the H1 clean-port/`ship` decision.
