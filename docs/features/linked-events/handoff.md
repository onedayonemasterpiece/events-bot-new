...
> Status: выборочная интеграция выполнена в
> `integration/static-crop-occurrences-20260721`; документ сохраняет provenance
> donor и обязательные release checks. Старые labs не merged wholesale.
