...
- [ ] В card media нет полей; обычный OCR/document не обрезан, очень высокий
      OCR/document обрезан не более чем на 20%; все media/card heights в ряду
      равны, а grouping минимизирует суммарную высоту страницы.
