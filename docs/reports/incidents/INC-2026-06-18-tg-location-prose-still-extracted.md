...
- 2026-06-18: follow-up root fix prepared for emoji/bullet-decorated temporal fragments: `🤗Завтра` now normalizes to the temporal token for fail-closed detection in both Telegram import and Smart Update.
