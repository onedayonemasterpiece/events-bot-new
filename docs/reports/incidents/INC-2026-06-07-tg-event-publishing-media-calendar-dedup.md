...
- Regression tests now also cover the 2036 cleanup-anchor regression: far-future cancelled/backlog `tg_event_publish` rows do not push fresh Telegram event posts outside the normal publish window.
