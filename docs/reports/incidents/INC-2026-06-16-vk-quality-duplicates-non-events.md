...
- follow-up regression 2026-06-16: `wall-231920894_3512` deleted with `wall.delete -> response=1`; follow-up code adds postponed-id drift pruning for non-active future events and tests `test_prune_deletes_cancelled_future_event` / `test_prune_deletes_live_post_by_postponed_id_for_cancelled_event`.
