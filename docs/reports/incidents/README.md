...
- `INC-2026-06-16-tg-phone-links.md`
  ...
  - Must not regress: `event.ticket_link=tel:+...` must become an explicit clickable Telegram `tel:` link with readable phone text; body phone numbers must be linkified outside existing anchors; Kaliningrad `4012` landlines must keep natural display formatting.
