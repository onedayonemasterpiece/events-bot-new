...
def _llm_gate_prompt(opp: dict[str, Any], surface: dict[str, Any]) -> str:
    checklist_questions = [
        ...
        "Это не локальная логистика уже обсуждаемого события/поста (например афиша/программа/расписание 1 дня, время, адрес), где общий acquisition-ответ не поможет?",
