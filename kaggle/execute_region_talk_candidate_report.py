...
def build_input_datasets(client: Any, *, run_id: str, username: str) -> list[str]:
    ...
    env_config = {
        ...
        "REGION_TALK_YDB_READ_MODEL_MODE": os.environ.get("REGION_TALK_YDB_READ_MODEL_MODE", "required"),
        "REGION_TALK_YDB_ALLOW_LEGACY_BROAD_READ_FALLBACK": os.environ.get("REGION_TALK_YDB_ALLOW_LEGACY_BROAD_READ_FALLBACK", "0"),
        "REGION_TALK_YDB_READ_MODEL_PAGE_LIMIT": os.environ.get("REGION_TALK_YDB_READ_MODEL_PAGE_LIMIT", "200"),
        "REGION_TALK_YDB_READ_MODEL_MAX_PER_QUEUE": os.environ.get("REGION_TALK_YDB_READ_MODEL_MAX_PER_QUEUE", "200"),
        "REGION_TALK_YDB_READ_MODEL_PUBLISH_READY": os.environ.get("REGION_TALK_YDB_READ_MODEL_PUBLISH_READY", "0"),
        ...
        "REGION_TALK_SOURCE_PROFILE_CAPTURE_ONLY": os.environ.get("REGION_TALK_SOURCE_PROFILE_CAPTURE_ONLY", "0"),
