...
def build_input_datasets(client: Any, *, run_id: str, username: str) -> list[str]:
    ...
    env_config = {
        ...
        "REGION_TALK_PUBLICATION_ELIGIBILITY_GATE_VERSION": os.environ.get("REGION_TALK_PUBLICATION_ELIGIBILITY_GATE_VERSION", "region_talk_publication_eligibility_v4"),
        ...
        "REGION_TALK_CONFIRMED_BLOGGER_FAST_CHECK_QUERIES_PER_SOURCE": os.environ.get("REGION_TALK_CONFIRMED_BLOGGER_FAST_CHECK_QUERIES_PER_SOURCE", "10"),
        ...
        "REGION_TALK_CONFIRMED_BLOGGER_HISTORY_SLOTS_PER_RUN": os.environ.get("REGION_TALK_CONFIRMED_BLOGGER_HISTORY_SLOTS_PER_RUN", "2"),
...
def main() -> int:
    ...
    os.environ.setdefault("REGION_TALK_CONFIRMED_BLOGGER_FAST_CHECK_QUERIES_PER_SOURCE", "10")
    os.environ.setdefault("REGION_TALK_CONFIRMED_BLOGGER_FAST_CHECK_RESULTS_PER_QUERY", "20")
    os.environ.setdefault("REGION_TALK_CONFIRMED_BLOGGER_HISTORY_SLOTS_PER_RUN", "2")
