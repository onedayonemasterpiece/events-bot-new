...
def kaggle_ydb_pip_spec() -> str:
    # The worker exchanges its authorized-key JWT through IAM REST, so the
    # Yandex Cloud SDK extra is unnecessary and must not replace Kaggle's
    # shared native dependencies after startup.
