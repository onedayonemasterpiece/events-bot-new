...
- **Docs / Lollipop Legacy Version Pin**: pinned `lollipop_legacy.v2` as the current lab contract in the canonical funnel doc, with git tag `lollipop-legacy-v2`, owner constant `LEGACY_CONTRACT_VERSION`, acceptance artifact `lollipop_g4_benchmark_20260430T115455Z`, and an explicit rule that contract-shaping changes must bump the next version.
