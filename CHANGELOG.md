...
### Changed
- Compact the two-tier mobile date dock to90px: inline dates and a labels-only lower row; standalone mobile navigation retains its icons and labels.
...
- Fixed: the festival mobile hero no longer permits an emphasized Russian word
  ...
  `0.72em` emphasis scale across 320–430px viewports. Its three fact columns
  also reserve enough width to keep adjacent uppercase labels from colliding
  at 320px.
