...
- Fixed Tretyakov daily premium venue marker scope: `🖼🖼` now uses the stable same-document pair, is not inferred from titles/descriptions such as `Александр Дейнека`, and old title-level pairs are cleaned back to the ordinary picture emoji.
