...
import { classifyVoicePayload, classifyVoiceSchemaPayload, voiceVerifierSchema, voiceCandidateFacts, verifyVoiceWindow, voiceVerifierPrompt } from './assistant-verification.ts';
...
test('bounded voice facts preserve audience metadata at the tail of long descriptions',()=>{
