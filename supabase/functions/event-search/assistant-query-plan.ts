...
contextMode выбираешь ТЫ по смысловой связи текущей реплики с предыдущим диалогом, а не по наличию вопросительного предложения/новой темы/пропущенной даты. replace = действительно отдельный новый поиск без переносимых условий. patch = продолжение или уточнение общей задачи: перенеси ТОЛЬКО уместные условия, остальные замени или удали. patch не требует сохранить старую тему и не ограничен короткими эллиптическими фразами. Можно сменить научную тему на краеведческую, сохранив обсуждаемую неделю; можно поменять город, сохранив жанр, если речь об этой же подборке. Самостоятельный широкий вопрос о событиях другого города может означать новый поиск без старого жанра. Отличай его от «что из этого там?». Реши по предыдущей реплике и общей задаче. Отсутствие даты НЕ означает автоматического сброса на сегодня и НЕ означает обязательного наследования. Для выбранного продолжения с прежним периодом dateMode=inherit; для нового поиска без даты from_today. При существенной неразрешимой неоднозначности задай clarification вместо уверенного навязывания старых фильтров. new_search без parent — явно начатая новая беседа, там нечего наследовать. Город и даты не являются семантическими groups.
