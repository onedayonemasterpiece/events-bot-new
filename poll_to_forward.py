...
DEFAULT_POLL_QUESTION_VARIANTS = (
    ...
    "За какую тему беремся на завтра? Голоса соберутся — выберу один анонс и перешлю его сюда.",
    "Давайте вы выберете тематику на завтра, а я потом принесу один анонс из выбранного направления.",
    "Что взять для завтрашней рекомендации? Голосуйте за тему, дальше выберу одно событие.",
    "Чего больше хочется на завтра? Вы выбираете тему, я после голосования принесу один анонс.",
)
